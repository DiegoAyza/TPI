...
database = {
    'usuario1': cv2.imread('TPI/img/huella1.jpg', cv2.IMREAD_GRAYSCALE),
    'usuario2': cv2.imread('TPI/img/huella2.jpg', cv2.IMREAD_GRAYSCALE),
    'usuario3': cv2.imread('TPI/img/huella3.jpg', cv2.IMREAD_GRAYSCALE)
}
